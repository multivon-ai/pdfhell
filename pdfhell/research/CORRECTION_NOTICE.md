...
- **What replicates on the redesigned families** (2026-06-12 PDF re-run, [`published_runs/2026-06-12-cross-modality/mini-v4-sample-anthropic-claude-opus-4-7-pdf-20260612.json`](../../published_runs/2026-06-12-cross-modality/mini-v4-sample-anthropic-claude-opus-4-7-pdf-20260612.json)): Opus 4-7's `zero_width_space_split` 0% **replicates** (0/10) on the redesigned family, so the Opus half of the finding stands on post-redesign data. Opus's `unicode_confusable_total` rises to 90%. Sonnet 4-6's and Gemini-Flash-Lite's `zero_width_space_split` 0% rows have **not** been re-run on the PDF modality and should be read as measurements of the retired implementation.
